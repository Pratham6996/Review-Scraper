...
URL = 'https://www.trustpilot.com/categories/doctor_surgeons'
HTML_DATA = requests.get(URL).text
BASE_URL = 'https://www.trustpilot.com/categories/doctor_surgeons?page='
URL_LIST = []
i = 1
SERVICES = []
NAME = []
...
print(df)
df.to_excel('DOCTORS_SURGEONS.xlsx')
